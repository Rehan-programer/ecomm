      ...
      <div className="min-h-screen flex items-center justify-center bg-[#f9fafb]">
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm font-medium text-[#17232D]">Email</label>
            <input
              name="email"
              type="email"
              placeholder="Enter your email"
              onChange={handleChange}
              className="w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#ff3d3d]"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="py-3 bg-[#ff3d3d] text-white font-semibold rounded-lg hover:bg-[#e33636] transition-all duration-300 shadow-md"
          >
            Login
          </button>
