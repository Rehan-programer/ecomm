              ...
              if (item.label === "Cart") {
                return (
                  <Link
                    key={item.id}
                    href={item.path}
                    className="p-2 rounded-full relative hover:cursor-pointer hover:bg-gray-100 transition"
                    aria-label={item.label}
                  >
                    <div className="absolute  flex justify-center hover:cursor-pointer bg-red-500 text-white text-xs items-center rounded-full h-4 w-4 top-0 right-0">
                      {cartItems.length}
                    </div>
                    <IconComp className="w-5 h-5 hover:cursor-pointer text-gray-700" />
                  </Link>
                );
              }
