...
//   // ✅ Initialize product active states whenever products change
//   useEffect(() => {
//     const initialStates = {};
...
//     queryClient.invalidateQueries({ queryKey: ["menProducts"] });
//   },
// });
...
//                 value={Array.isArray(form.size) ? form.size.join(", ") : form.size}
//                 onChange={handleChange}
//                 className="w-full border rounded-lg p-2"
//               />
//               <input
